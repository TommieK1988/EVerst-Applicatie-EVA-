...
import { maakQuote, maakClient } from '@/app/actions/quotes'
        ...
        <div className="max-w-2xl mx-auto px-6 space-y-4">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
                {!nieuwKlant ? (
                  <>
                    ...
                    <button
                      onClick={() => setNieuwKlant(true)}
                      className="text-sm text-everts hover:underline font-medium"
                    >
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={() => setNieuwKlant(false)} className="text-xs text-slate-400 hover:text-slate-600">
                        Annuleren
                      </button>
                    </div>
                    <div>
          ...
          <div className="flex items-center justify-between pt-2">
            <button
              ...
              disabled={stap === 0}
              className="px-4 py-2 border border-slate-300 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
              Vorige
            </button>

...
import { berekenLijnTotaal, formatEuro, formatGetal } from '@/lib/calculations'
import { nieuweId } from '@/lib/utils'
import ActiviteitToevoegenModal from './ActiviteitToevoegenModal'
import type { Selectie, Scenario, Activiteit, CalculatieLijn, Element, Eenheid } from '@/lib/types'
import { EENHEDEN, LIJN_TYPES } from '@/lib/types'
              ...
              <div className="flex items-center gap-2">
                {(['arbeid', 'materiaal', 'materieel', 'onderaannemer'] as const).map(t => (
                  <button
                    ...
                    className="text-xs text-slate-400 hover:text-everts flex items-center gap-1 px-2 py-1 rounded hover:bg-everts-50 transition-colors"
                  >
        ...
        <td colSpan={18} className="px-3 py-2">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-xs text-everts hover:text-everts-dark flex items-center gap-1 px-2 py-1 rounded hover:bg-everts-50 transition-colors"
            >
            ...
            <button
              ...
              className="text-xs text-slate-500 hover:text-everts flex items-center gap-1 px-2 py-1 rounded hover:bg-everts-50 transition-colors"
            >
              <Plus className="w-3 h-3" />
              Activiteit
            </button>
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 bg-white flex-shrink-0">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-everts hover:bg-everts-dark text-white font-medium px-3 py-2 rounded-lg text-sm transition-colors"
        >
      ...
      <div className="flex-1 overflow-auto">
        {elementen.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full py-20 text-center">
            ...
            <p className="text-slate-500 font-medium mb-1">Nog geen begrotingsregels</p>
            <p className="text-slate-400 text-sm mb-4">Voeg een begrotingsregel toe om te beginnen met calculeren.</p>
            <button
              onClick={voegBegrotingsregelToe}

...
import type { Meetstaat, Groep, Calculatieregel } from '@/lib/types'
import { calculatieregelOmschrijving } from '@/lib/meetstaat-utils'
...
import { haalSchilderDropdownData, haalCombinaties } from '@/app/actions/schilderwerk'
      ...
      <div className="flex-shrink-0 bg-white border-b border-slate-200 px-4 py-2.5 flex items-center gap-3">
        {onSluit ? (
          ...
          >
            ...
            <span className="hidden sm:inline">{projectNaam ?? 'Project'}</span>
          </Link>
        )}

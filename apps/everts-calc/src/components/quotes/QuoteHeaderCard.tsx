  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200">
      <div className="px-4 py-3 border-b border-slate-100">
        <h3 className="text-sm font-semibold text-slate-700">Offerte gegevens</h3>
      </div>
        ...
        {templates.length > 0 && (
          <div className="flex items-center gap-2 p-2.5 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <button
              ...
              className="text-xs px-2.5 py-1 bg-white border border-slate-300 text-slate-600 hover:bg-everts hover:text-white hover:border-everts rounded transition-colors whitespace-nowrap"
            >
              Laden
            </button>
          </div>

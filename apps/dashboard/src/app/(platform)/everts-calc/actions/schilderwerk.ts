...
import { getSchilderOnderdelen, getSchilderTypes, getSchilderBehandelingen } from '@/lib/everts-calc/services/schilderwerk'
import type { SchilderCombinatie, SchilderOnderdeel, SchilderType, SchilderBehandeling } from '@/lib/everts-calc/services/schilderwerk'
...
export async function laadSchilderwerkData(): Promise<{
...
export async function haalSchilderDropdownData() {
  const { getSchilderDropdownData } = await import('@/lib/everts-calc/services/schilderwerk')
  return getSchilderDropdownData()
}

export async function haalCombinaties(type_id: string): Promise<SchilderCombinatie[]> {
  const { getSchilderCombinaties } = await import('@/lib/everts-calc/services/schilderwerk')

...
export default async function OfferteTabPage(props: {
  ...
  redirectOudeTab('offerte', params.id, params.tab)
  return <DossierTabContent id={params.id} tab={params.tab} sectie="offerte" deel={query.deel} />
}

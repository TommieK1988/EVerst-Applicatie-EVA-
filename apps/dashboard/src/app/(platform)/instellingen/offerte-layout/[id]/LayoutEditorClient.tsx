...
const WORD_VARIABELEN: { groep: string; items: { v: string; label: string }[] }[] = [
  ...
  { groep: 'Offerte', items: [
    ...
    { v: 'offerte.termijnschema',     label: 'Termijnschema — termijnen tekstueel uitgeschreven (één per regel)' },
  ...
  { groep: 'Klant', items: [
    ...
    { v: 'klant.contactpersoon',     label: 'Contactpersoon (uit het dossier)' },
    { v: 'klant.contactpersoon_email', label: 'Contactpersoon — e-mail' },
    { v: 'klant.contactpersoon_telefoon', label: 'Contactpersoon — telefoon' },
    ...
    { v: 'klant.betalingstermijn_dagen', label: 'Betalingstermijn in dagen (uit de relatiegegevens)' },
  ]},
  { groep: 'Contactpersoon (klant)', items: [
    { v: 'contactpersoon.volledige_naam', label: 'Volledige naam' },
    { v: 'contactpersoon.aanhef',         label: 'Aanhef (bv. Mevrouw)' },
    { v: 'contactpersoon.voornaam',       label: 'Voornaam' },
    { v: 'contactpersoon.tussenvoegsel',  label: 'Tussenvoegsel' },
    ...
    { v: 'contactpersoon.linkedin',       label: 'LinkedIn URL' },
    { v: 'contactpersoon.opmerkingen',    label: 'Opmerkingen' },
  ]},
  ...
  { groep: 'Werk / Dossier', items: [
    ...
    { v: 'dossier.controller',       label: 'Controller' },
  ...
  { groep: 'Totalen', items: [
    ...
    { v: 'totalen.subtotaal_raw',          label: 'Subtotaal — kaal, mét duizendpunt (10.000,00)' },
    ...
    { v: 'totalen.btw_bedrag_raw',         label: 'BTW bedrag — kaal, mét duizendpunt (2.100,00)' },
    { v: 'totalen.totaal',                 label: 'Totaal incl. BTW (bv. € 12.100,00)' },
    { v: 'totalen.totaal_bedrag',          label: 'Totaal met duizendpunt, zonder € (12.100,00)' },
    { v: 'totalen.totaal_raw',             label: 'Totaal incl. BTW — kaal, mét duizendpunt (12.100,00)' },
    ...
    { v: 'totalen.stelposten_subtotaal_raw', label: 'Totaal stelposten — kaal, mét duizendpunt (750,00)' },
    ...
    { v: 'totalen.opties_subtotaal_raw',   label: 'Totaal opties — kaal, mét duizendpunt (1.250,00)' },
  ...
  { groep: 'Loop: btw_groepen (per BTW-tarief)', items: [
    ...
    { v: 'grondslag_raw',            label: 'Grondslag — kaal, mét duizendpunt (10.000,00)' },
  ...
  { groep: 'Teksten', items: [
    { v: '@inleiding',               label: 'Inleidende tekst MÉT opmaak (vet, cursief, bullets) — let op de @' },
  ...
  { groep: 'Loop: normale_secties', items: [
    ...
    { v: 'subtotaal_raw',            label: 'Subtotaal — kaal, mét duizendpunt (5.000,00)' },
  ...
  { groep: 'Loop: regels (binnen een sectie)', items: [
    ...
    { v: 'eenheidsprijs_raw',        label: 'Prijs per eenheid — kaal, mét duizendpunt (12,50)' },
    ...
    { v: '/afbeeldingen',            label: 'Einde loop foto’s' },
  ...
  { groep: 'Loop: stelpost_regels (plat)', items: [
    ...
    { v: 'totaal_raw',               label: 'Bedrag — kaal, mét duizendpunt (750,00)' },
  ]},
  ...
  { groep: 'Loop: boom (genest, met opgetelde totalen)', items: [
    { v: '#boom',                    label: 'Begin loop — niveau-1 groepen (genest)' },
    { v: '/boom',                    label: 'Einde loop' },
    { v: '#kinderen',                label: 'Begin loop — subgroepen één niveau dieper' },
    { v: '/kinderen',                label: 'Einde loop' },
    { v: 'display_naam',             label: 'Genummerde naam van de groep' },
    { v: 'naam',                     label: 'Naam van de groep' },
    { v: 'nummer',                   label: 'Nummer (bv. "1.1")' },
    { v: 'niveau',                   label: 'Niveau (1, 2 of 3)' },
    { v: 'subtotaal_incl',           label: 'OPGETELD totaal — eigen regels + alle kinderen (bv. € 12.500,00)' },
    { v: 'subtotaal_incl_bedrag',    label: 'Opgeteld totaal (12.500,00, zonder €)' },
    { v: 'subtotaal',                label: 'Alleen eigen regels van déze groep (bv. € 5.000,00)' },
    { v: 'heeft_kinderen',           label: 'Boolean: heeft deze groep subgroepen' },
    { v: 'heeft_regels',             label: 'Boolean: heeft deze groep eigen regels' },
    { v: '#regels',                  label: 'Begin loop — eigen regels (zie "Loop: regels" voor velden)' },
    { v: '/regels',                  label: 'Einde loop' },
  ]},
  { groep: 'Begrotingsstaat: regel (binnen {#regels})', items: [
    { v: 'kostengroep_naam',         label: 'Kostengroep uit de calculatie (bv. Bouwplaats)' },
    { v: 'verrekenprijs',            label: 'VRR — verrekenprijs p/e (€); leeg als de regel niet verrekenbaar is' },
    { v: 'verrekenprijs_bedrag',     label: 'Verrekenprijs (12,50, zonder €)' },
    { v: 'verrekenprijs_raw',        label: 'Verrekenprijs — kaal (12,50)' },
    { v: 'is_verrekenbaar',          label: 'Boolean: VRR-post' },
    { v: 'uren_per_eenheid',         label: 'Uren per eenheid (leeg als onbekend; 0 blijft 0)' },
    { v: 'kostprijs_per_eenheid',    label: 'Kostprijs per eenheid (€)' },
    { v: 'kostprijs_per_eenheid_bedrag', label: 'Kostprijs p/e (zonder €)' },
    { v: 'kostprijs_per_eenheid_raw',    label: 'Kostprijs p/e — kaal' },
    { v: 'minuten_per_eenheid',      label: 'Minuten per eenheid (uren p/e × 60)' },
    { v: 'arbeid_tarief',            label: 'Uurtarief arbeid (€) — arbeidsbedrag ÷ uren' },
    { v: 'arbeid_tarief_bedrag',     label: 'Uurtarief (42,50, zonder €)' },
    { v: 'arbeid_tarief_raw',        label: 'Uurtarief — kaal (42,50)' },
    { v: 'arbeid_prijs_per_eenheid', label: 'Arbeid per eenheid (€)' },
    { v: 'arbeid_bedrag',            label: 'Totaal arbeid van deze regel (€)' },
    { v: 'arbeid_bedrag_getal',      label: 'Totaal arbeid (1.250,00, zonder €)' },
    { v: 'arbeid_bedrag_raw',        label: 'Totaal arbeid — kaal (1.250,00)' },
    { v: 'materiaal_prijs_per_eenheid', label: 'Materiaal per eenheid (€)' },
    { v: 'materiaal_bedrag',         label: 'Totaal materiaal van deze regel (€)' },
    { v: 'materiaal_bedrag_getal',   label: 'Totaal materiaal (zonder €)' },
    { v: 'materiaal_bedrag_raw',     label: 'Totaal materiaal — kaal' },
    { v: 'oa_prijs_per_eenheid',     label: 'Onderaanneming per eenheid (€)' },
    { v: 'oa_bedrag',                label: 'Totaal onderaanneming van deze regel (€)' },
    { v: 'oa_bedrag_getal',          label: 'Totaal onderaanneming (zonder €)' },
    { v: 'oa_bedrag_raw',            label: 'Totaal onderaanneming — kaal' },
    { v: 'uren_totaal',              label: 'Totaal uren van deze regel (uren p/e × aantal)' },
    { v: 'kostprijs_totaal',         label: 'Totale kostprijs van deze regel (€)' },
    { v: 'kostprijs_totaal_bedrag',  label: 'Totale kostprijs (zonder €)' },
    { v: 'kostprijs_totaal_raw',     label: 'Totale kostprijs — kaal' },
    { v: 'opslag_pct',               label: 'Opslag op de kostprijs, AK inbegrepen (bv. 12,5%)' },
    { v: 'opslag_pct_raw',           label: 'Opslag — kaal (12,5)' },
    { v: 'opslag_bedrag',            label: 'Opslagbedrag van deze regel (€) — verkoop − kostprijs' },
    { v: 'opslag_bedrag_getal',      label: 'Opslagbedrag (zonder €)' },
    { v: 'opslag_bedrag_raw',        label: 'Opslagbedrag — kaal' },
  ]},
  { groep: 'Begrotingsstaat: groep ({#boom} / {#kinderen})', items: [
    { v: 'eigen.uren',               label: 'Uren — alleen de eigen regels van deze groep' },
    { v: 'eigen.arbeid_bedrag',      label: 'Arbeid (€) — eigen regels' },
    { v: 'eigen.materiaal_bedrag',   label: 'Materiaal (€) — eigen regels' },
    { v: 'eigen.oa_bedrag',          label: 'Onderaanneming (€) — eigen regels' },
    { v: 'eigen.kostprijs',          label: 'Kostprijs (€) — eigen regels' },
    { v: 'eigen.verkoop',            label: 'Verkoopprijs (€) — eigen regels' },
    { v: 'eigen.opslag_bedrag',      label: 'Opslagbedrag (€) — eigen regels' },
    { v: 'eigen.opslag_pct',         label: 'Effectieve opslag % — eigen regels' },
    { v: 'incl.uren',                label: 'Uren — OPGETELD: eigen regels + alle subgroepen' },
    { v: 'incl.arbeid_bedrag',       label: 'Arbeid (€) — opgeteld' },
    { v: 'incl.materiaal_bedrag',    label: 'Materiaal (€) — opgeteld' },
    { v: 'incl.oa_bedrag',           label: 'Onderaanneming (€) — opgeteld' },
    { v: 'incl.kostprijs',           label: 'Kostprijs (€) — opgeteld' },
    { v: 'incl.verkoop',             label: 'Verkoopprijs (€) — opgeteld' },
    { v: 'incl.opslag_bedrag',       label: 'Opslagbedrag (€) — opgeteld' },
    { v: 'incl.opslag_pct',          label: 'Effectieve opslag % — opgeteld' },
    { v: 'incl.kostprijs_volledig',  label: 'Boolean: elke regel had een kostprijs (anders valt de opslag te hoog uit)' },
  ]},
  { groep: 'Begrotingsstaat: eindtotalen', items: [
    { v: 'totalen.uren',             label: 'Totale uren' },
    { v: 'totalen.arbeid_bedrag',    label: 'Totaal arbeid (€)' },
    { v: 'totalen.materiaal_bedrag', label: 'Totaal materiaal (€)' },
    { v: 'totalen.oa_bedrag',        label: 'Totaal onderaanneming (€)' },
    { v: 'totalen.kostprijs',        label: 'Totale kostprijs (€)' },
    { v: 'totalen.opslag_bedrag',    label: 'Totaal opslagbedrag (€) — verkoop − kostprijs' },
    { v: 'totalen.opslag_pct',       label: 'Opslag % over de kostprijs (AK inbegrepen)' },
    { v: 'totalen.marge_bedrag',     label: 'Margebedrag (€) — zelfde bedrag als de opslag' },
    { v: 'totalen.marge_pct',        label: 'Marge % over de verkoopprijs' },
    { v: 'totalen.kostprijs_volledig', label: 'Boolean: elke regel had een kostprijs' },
  ]},
  { groep: 'Loop: betalingstermijnen (termijnschema)', items: [
    { v: '#offerte.betalingstermijnen', label: 'Begin loop — termijnen van de betalingsconditie' },
    { v: '/offerte.betalingstermijnen', label: 'Einde loop' },
    { v: 'nummer',                   label: 'Volgnummer van de termijn (1, 2, 3…)' },
    { v: 'percentage',               label: 'Percentage — kaal (bv. 50)' },
    { v: 'percentage_str',           label: 'Percentage met % (bv. 50%)' },
    { v: 'omschrijving',             label: 'Omschrijving van de termijn' },
    { v: 'regel',                    label: 'Volledige regel (zoals in het termijnschema)' },
  ]},
  { groep: 'Conditionele blokken', items: [
    { v: '#heeft_stelposten',        label: 'Als er stelposten zijn' },
    { v: '#offerte.heeft_termijnschema', label: 'Als er een termijnschema is' },
    { v: '/offerte.heeft_termijnschema', label: 'Einde conditioneel blok' },

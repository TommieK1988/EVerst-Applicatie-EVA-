...
const WORD_VARIABELEN: { groep: string; items: { v: string; label: string }[] }[] = [
  ...
  { groep: 'Totalen', items: [
    ...
    { v: 'totalen.subtotaal_raw',          label: 'Subtotaal — kaal, mét duizendpunt (10.000)' },
    ...
    { v: 'totalen.btw_bedrag_raw',         label: 'BTW bedrag — kaal, mét duizendpunt' },
    { v: 'totalen.totaal',                 label: 'Totaal incl. BTW (bv. € 12.100,00)' },
    { v: 'totalen.totaal_bedrag',          label: 'Totaal met duizendpunt, zonder € (12.100,00)' },
    { v: 'totalen.totaal_raw',             label: 'Totaal incl. BTW — kaal, mét duizendpunt' },
    ...
    { v: 'totalen.stelposten_subtotaal_raw', label: 'Totaal stelposten — kaal, mét duizendpunt' },
    ...
    { v: 'totalen.opties_subtotaal_raw',   label: 'Totaal opties — kaal, mét duizendpunt' },
  ...
  { groep: 'Loop: btw_groepen (per BTW-tarief)', items: [
    ...
    { v: 'grondslag_raw',            label: 'Grondslag — kaal, mét duizendpunt' },
    { v: 'btw_bedrag',               label: 'BTW-bedrag over dit tarief (€)' },
    { v: 'btw_bedrag_getal',         label: 'BTW-bedrag (2.100,00, zonder €)' },
    { v: 'btw_bedrag_raw',           label: 'BTW-bedrag — kaal, mét duizendpunt' },
  ]},
  { groep: 'Teksten', items: [
  ...
  { groep: 'Loop: normale_secties', items: [
    ...
    { v: 'subtotaal_raw',            label: 'Subtotaal — kaal, mét duizendpunt (5.000)' },
  ...
  { groep: 'Loop: regels (binnen een sectie)', items: [
    ...
    { v: 'eenheidsprijs_raw',        label: 'Prijs per eenheid — kaal, mét duizendpunt' },
    { v: 'totaal',                   label: 'Totaalbedrag regel (bv. € 131,25)' },
    { v: 'totaal_bedrag',            label: 'Totaalbedrag (131,25, zonder €)' },
    { v: 'totaal_raw',               label: 'Totaal — kaal, mét duizendpunt' },
  ...
  { groep: 'Loop: stelpost_regels (plat)', items: [
    ...
    { v: 'totaal_raw',               label: 'Bedrag — kaal, mét duizendpunt' },
  ]},

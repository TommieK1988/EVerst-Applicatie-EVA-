...
export default async function ServicedeskTabPage(props: {
  ...
  redirectOudeTab('servicedesk', params.id, params.tab)
  return <DossierTabContent id={params.id} tab={params.tab} sectie="servicedesk" deel={query.deel} />
}

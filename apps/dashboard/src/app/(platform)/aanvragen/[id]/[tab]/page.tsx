...
export async function generateMetadata(props: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return dossierMetadata(id, 'Aanvraag')
}

export default async function AanvraagTabPage(props: {
  ...
  redirectOudeTab('aanvraag', params.id, params.tab)
  return <DossierTabContent id={params.id} tab={params.tab} sectie="aanvraag" deel={query.deel} />
}

/**
 * De compliance-controle draaien: alle regels over de ritten van dit jaar.
 *
 ...
 * ingelogde gebruiker — die rechtencontrole hoort dus in de action te blijven
 * en niet hier. Alles wat deze module exporteert draait dus ZONDER
 * rechtencontrole; roep het alleen aan vanuit een action die zelf gecontroleerd
 * heeft, of vanuit een cron-route achter `CRON_SECRET`.
 */
import 'server-only'
...
export async function voerComplianceUit(): Promise<{
  totaal: number

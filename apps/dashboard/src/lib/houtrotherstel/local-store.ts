...
export function getMedewerkerNaam(): string {
  ...
  return localStorage.getItem(KEYS.medewerker) || ''
}
...
export function getAllBibliotheek(): StandardRepair[] {
  return getLocalBibliotheek().sort((a, b) => a.code.localeCompare(b.code))
}

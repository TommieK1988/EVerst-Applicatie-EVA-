...
export interface DbTask {
  ...
  /**
   * Aanlooptijd: aantal dagen na de start van de uitvoering waarop de eerste keer valt.
   * 0 = meteen de eerste dag. Schuift de hele reeks op, dus het interval blijft intact.
   */
  ...
  /** Deze actie start een projectbezoek. */
  bezoek_ronde: boolean
  /**
   * Deze actie start een opname (mutatiewerk). Zelfde mechaniek: startknop op de taak, en gereed
   * zodra de opname is afgerond of naar de calculatie is gezet.
   */

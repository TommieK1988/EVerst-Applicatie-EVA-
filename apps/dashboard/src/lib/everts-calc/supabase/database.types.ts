...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      dossiers: {
        Row: {
          ...
          offerte_substatus: Database["public"]["Enums"]["offerte_substatus"]
          opdracht_substatus:
            | Database["public"]["Enums"]["opdracht_substatus"]
            | null
      ...
      relaties: {
        Row: {
          ...
          opmerkingen: string | null
          telefoon: string | null
          type: Database["public"]["Enums"]["relatie_type"]
          updated_at: string
          website: string | null
        }
        Insert: {
    ...
    Enums: {
      ...
      relatie_type: "klant" | "leverancier" | "onderaannemer"

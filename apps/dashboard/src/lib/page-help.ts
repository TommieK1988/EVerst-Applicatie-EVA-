...
const PAGE_HELP: Array<[RegExp, PageHelp]> = [
  ...
  [/^\/uren\/goedkeuren$/, {
    ...
    sections: [
      ...
      { title: 'Uit Bouw7', body: 'Het vierde tabblad zijn de uren die in Bouw7 zelf zijn ingevoerd en daar nog op akkoord wachten. Bouw7 legt niet vast wie moet goedkeuren, dus EVA bepaalt dat: je ziet de uren van de mensen waarvan je teamleider bent, en de uren die anderen op jouw projecten boekten. Als teamleider gaat je akkoord pas naar Bouw7 zodra ook de projectleider heeft gekeken; heeft het project geen projectleider, dan meteen. De projectleider mag de teamleider altijd overrulen.' },

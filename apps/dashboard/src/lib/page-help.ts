...
const PAGE_HELP: Array<[RegExp, PageHelp]> = [
  ...
  [/^\/wagenpark\/werktijden$/, {
    ...
    sections: [
      ...
      { title: 'Je werklijst', body: 'De pagina toont standaard alleen dagen die nog nagekeken moeten worden, dus de lijst krimpt terwijl je hem afwerkt. Zet het vinkje "Alleen nog te controleren" uit om ook de afgehandelde dagen te zien, bijvoorbeeld om een gesprek voor te bereiden.' },
      ...
      { title: 'Delen met de medewerker', body: 'Filter op één medewerker en kies de periode. Klik dan op Exporteer: je krijgt een Excel-bestand met één regel per dag, waarin de afwijking en de geboekte uren als getal staan. Daarmee kan de medewerker de optelling zelf narekenen.' },

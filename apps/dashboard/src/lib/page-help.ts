...
const PAGE_HELP: Array<[RegExp, PageHelp]> = [
  ...
  [/^\/aanvragen$/, {
    ...
    sections: [
      ...
      { title: 'Verkoopkansen', body: 'Achter de knop "Verkoopkansen" staat het werk dat later terugkomt: kansen die zijn vastgelegd toen een offerte verloren ging, verviel of werd uitgesteld. Elke kans heeft een korte uitleg, één collega die erachteraan gaat en een datum waarop dat gebeurt; klik een regel aan om die aan te passen of de kans af te vinken. Een kans die je oppakt wordt een nieuwe aanvraag — vandaar dat ze hier staan en niet bij Offertes.' },
    ],
  }],
  ...
  [/^\/offertes$/, {
    ...
    sections: [
      ...
      { title: 'Acties tellen mee als volgende stap', body: 'Staat er op het dossier al een openstaande actie met een deadline — bijvoorbeeld "Offerte nabellen" — dan gebruikt EVA die als volgende stap, met de deadline als datum en de toegewezen collega als actiehouder. Je hoeft hem dus niet nog een keer in te vullen. Op de kaart staat er dan "uit de actielijst" achter, zodat je ziet dat het overgenomen is en nog geen commerciële afspraak. Leg je een uitkomst vast, dan wordt die actie meteen afgevinkt en neemt jouw afspraak het over. Vink je de actie in de actielijst af, dan schuift de kaart door naar de eerstvolgende openstaande actie, of vraagt hij om een nieuwe stap.' },
      ...
      { title: 'Wat EVA automatisch doet', body: 'Een nieuwe offerte die in Bouw7 op Verstuurd komt verschijnt vanzelf op het bord als "nog niet beoordeeld". Een actie waarvan de datum verstrijkt wordt vanzelf rood. Een wachtende offerte komt vanzelf terug op de hercontroledatum, ook als die een jaar vooruit ligt. Fasewijzigingen worden automatisch gelogd, zodat je later kunt zien hoe lang een offerte in elke fase stond. En offertes vanaf € 20.000 zonder eigenaar of vervolgstap krijgen een uitroepteken achter het bedrag. Acties op een offertedossier worden doorlopend bijgehouden: nieuwe acties met een deadline verschijnen meteen als volgende stap, afgevinkte acties verdwijnen er weer uit.' },
  ...
  [/^\/offertes\/[^/]+\/bewaking$/, {
    ...
    sections: [
      { title: 'De kaart', body: 'Bovenaan staat in één oogopslag het offertebedrag, de klant, de eigenaar, de bewakingsstatus, de volgende stap met datum en wie er nu aan zet is. Een collega moet hieraan genoeg hebben om te bepalen of hij zelf nog iets moet doen. Staat er "uit de actielijst" bij de volgende stap, dan is die overgenomen van een openstaande actie op dit dossier en heeft nog niemand een commerciële afspraak vastgelegd. Leg je een uitkomst vast, dan wordt die actie meegeafvinkt.' },
  ...
  [/^\/wagenpark\/dashboard$/, {
    ...
    sections: [
      { title: 'Periode kiezen', body: 'De knoppenbalk bovenaan bepaalt over welke periode de hele pagina rekent: dit of vorig kwartaal, dit of vorig jaar, of een eigen van-tot. Alle tegels en de werktijdenlijst bewegen mee. Alleen "Actieve voertuigen" niet — dat is een momentopname van het wagenpark, geen periodecijfer. De keuze staat in het webadres, dus je kunt hem bewaren of doorsturen.' },
      { title: 'Statistieken', body: 'De tegels geven direct inzicht: actieve voertuigen, openstaande bevindingen uit de gekozen periode, zakelijke en privé­kilometers in die periode, en — met het recht "Wagenpark: privé & werktijden" — hoeveel er in totaal te laat is begonnen en te vroeg gestopt. Kleuren geven aan of waarden binnen de norm vallen.' },
      { title: 'Werktijden per medewerker', body: 'Eén regel per medewerker: hoeveel minuten te laat en te vroeg, met een kolom per maand zodat je het verloop ziet. Verklaarde dagen staan in een eigen kolom en tellen nergens in mee. Klik op een medewerker om naar zijn bestuurderspagina te gaan; daar staan de dagen zelf, de ritten per dag en de uitdraai. Alleen zichtbaar met het recht "Wagenpark: privé & werktijden" — standaard heeft alleen Directie dat.' },
  ...
  [/^\/wagenpark\/bestuurders\/[^/]+$/, {
    ...
    sections: [
      ...
      { title: 'Werktijden — hoe de tijden worden bepaald', body: 'Aankomst op het werk is het einde van de eerste zakelijke ritketen van de dag; vertrek is het begin van de laatste. Ritten met minder dan vijf minuten ertussen tellen als één rit, zodat een tankstop of een opgeknipte registratie niet voor aankomst wordt aangezien. Elke stop telt als werkplek — ook de groothandel of het depot. De grens is de dagstart en het dageind uit het werkrooster. Dagen met verlof worden overgeslagen, net als de lopende dag. Een ≈ achter de roostertijd betekent dat er op die datum nog geen rooster gold en de dichtstbijzijnde is gebruikt.' },
      { title: 'Werktijden — een dag controleren', body: 'Klik op een regel in het werktijden-blok. Het zijpaneel zet naast elkaar wat het rooster zei, wat de auto deed en wat er die dag in Bouw7 geboekt is per uursoort, en toont alle ritten van die dag — met de ritketen die de aankomst of het vertrek bepaalde groen gemarkeerd. Daarmee zie je meteen of het signaal ergens op slaat: acht uur geschreven terwijl de auto om 15:00 wegreed is iets om te bespreken, zes uur plus twee uur verlof is verklaard.' },
      { title: 'Werktijden — afvinken', body: 'In het paneel kies je Verklaard (geen actie nodig) of Bespreken (meenemen in een gesprek). Een toelichting is optioneel maar handig — hij wordt met je naam en het tijdstip vastgelegd. Een verklaarde dag verdwijnt niet: de afwijking wordt doorgestreept getoond en telt nergens meer in mee. Vergist? Met "Terug naar te controleren" zet je hem terug.' },
      { title: 'Werktijden — uitdraai voor een gesprek', body: 'Kies de periode en klik op "Uitdraai (PDF)": één pagina op briefpapier met de totalen, het verloop per maand, alle dagen en een uitleg van wat er gemeten is. Wil je liever rekenen, gebruik dan Exporteer in de tabel voor een Excel-bestand met de afwijking en de geboekte uren als getal. Deze cijfers gaan over een met naam genoemde medewerker: deel ze alleen met de betrokkene zelf en met wie het functioneel nodig heeft.' },
    ],
  }],
  ...
  [/^\/facturen$/, {
    ...
    sections: [
      ...
      { title: 'Interne notitie (Bouw7)', body: 'De interne notitie die op de factuur in Bouw7 staat — daar noteert de administratie het debiteurencontact ("gesproken met…, staat klaar voor betaling") — is hier zichtbaar: als kolom in de lijst en volledig in het zijpaneel. Andersom werkt het ook: elke opmerking die je hier in het logboek toevoegt, wordt bovenaan diezelfde notitie in Bouw7 bijgeschreven, met datum en jouw naam erbij. Zo staat het debiteurenverhaal in beide systemen compleet, of je collega nu in EVA of in Bouw7 kijkt.' },
  ...
  [/^\/management\/verkoop$/, {
    ...
    sections: [
      ...
      { title: 'Tijd per fase', body: 'Hoe lang een offerte gemiddeld in elke fase staat, berekend uit de fasehistorie die EVA automatisch bijhoudt. Alleen afgeronde verblijven tellen mee: de fase waar een offerte nú in zit is nog niet klaar. Loopt Actie op, dan blijven offertes te lang liggen ná verzending; loopt Wachten op, dan wachten klanten te lang op antwoord van ons. Kijk bij weinig metingen naar de mediaan, niet naar het gemiddelde.' },
    ...
    case 'informatie':
      return T('Informatie',
        ...
        [
          ...
          { title: 'Alles gaat naar Bouw7', body: 'Bij een gekoppeld dossier gaan projectnaam, categorie, referentie, werkadres, contactpersoon, opdrachtgever, object, deadline, voorlopige planning en de VvE-code bij het opslaan meteen mee naar het Bouw7-project; je hoeft ze daar niet nog eens in te vullen. Lukt dat even niet, bijvoorbeeld bij een storing, dan blijft je invoer in EVA staan en probeert EVA het vanzelf opnieuw — je ziet dan een regel onder het blok. Alleen de werkmaatschappij ligt na het aanmaken vast, omdat het projectnummer daaraan hangt.' },

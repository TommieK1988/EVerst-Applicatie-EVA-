...
function MeekijkersBlok({
  ...
  return (
    <Card>
      ...
      <CardBody>
        <ul className="divide-y divide-neutral-100">
            {/* Nog geen meekijkers: dezelfde regelvorm, leeg. */}
            {meekijkers.length === 0 && (
              <li className="flex flex-wrap items-center justify-between gap-3 py-2.5 first:pt-0 text-neutral-400">
                <div className="min-w-0">
                  <p className="text-sm font-semibold">—</p>
                  <p className="mt-0.5 text-xs">
                    Nog geen meekijkers. Gebruik dit voor iemand die niet bij de opdrachtgever hoort maar
                    het werk wel moet kunnen volgen &mdash; een VvE-voorzitter, of een adviseur die de
                    klant heeft ingehuurd.
                  </p>
                </div>
              </li>
            )}

...
function ReparatieTypesBlok() {
  ...
  return (
    <Card>
      <CardHeader>Reparatietypes</CardHeader>
      <CardBody className="space-y-5">
        <p className="text-sm text-neutral-400 -mt-2">Definieer de types die gebruikt worden in de bibliotheek en bij reparaties</p>
        ...
        <div className="space-y-2">
          {types.length === 0 && (
            <EmptyState
              size="sm"
              tone="neutral"
              title="Nog geen types gedefinieerd"
            />
          )}
          {types.map(t => (
              ...
              {editId === t.id ? (
                ...
                <div className="border border-everts/30 bg-everts-50 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Button size="sm" variant="primary" onClick={bewerkOpslaan}>
                      Opslaan
                    </Button>
...
function UurtariefBlok() {
  ...
  return (
    <Card>
      <CardHeader>Uurtarief</CardHeader>
      <CardBody className="space-y-5">
        <p className="text-sm text-neutral-400 -mt-2">Wordt gebruikt voor het berekenen van de arbeidskosten in de bibliotheek</p>

  ...
  return (
    <Dialog open onOpenChange={open => { if (!open) onClose() }}>
      <DialogContent size="lg">
        <DialogHeader>
          <DialogTitle>{item ? 'Reparatie bewerken' : 'Nieuwe reparatie'}</DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter>
          <Button variant="outline" size="lg" onClick={onClose}>Annuleren</Button>
          <Button variant="primary" size="lg" onClick={opslaan} disabled={!form.code.trim() || !form.name.trim()}>Opslaan</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )

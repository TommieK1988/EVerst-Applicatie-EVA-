...
const APP_SUBNAV: Record<string, {
  ...
  '/materieelbeheer': {
    ...
    items: [
      ...
      { href: '/materieelbeheer',              label: 'Overzicht',       icon: ICON_OVERZICHT },
  ...
  '/management': {
    ...
    items: [
      ...
      { href: '/management/werkvoorraad', label: 'Werkvoorraad',  icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
...
/** Envelop met klok: uitgezet werk waar je nog antwoord op wacht. Los gezet omdat hij in
 *  twee tab-arrays staat. */
const UITVRAAG_ICOON =
  'M3 6.5A1.5 1.5 0 0 1 4.5 5h15A1.5 1.5 0 0 1 21 6.5v6.2M3 6.5v10A1.5 1.5 0 0 0 4.5 18h8.2M3 6.9l9 5.6 9-5.6M17.5 15v2.2l1.6 1.1M17.5 21a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z'
...
const AANVRAAG_TABS: DossierTab[] = [
  ...
  { slug: 'uitvraag',   label: 'Uitvraag',   d: UITVRAAG_ICOON },

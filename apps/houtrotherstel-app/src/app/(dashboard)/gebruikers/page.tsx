...
const mockGebruikers = [
  mockProfile,
  { ...mockProfile, id: 'mock-2', full_name: 'Jan Platform', email: 'platform@houtrotherstel.nl', role: 'platform_gebruiker' as const },
  { ...mockProfile, id: 'mock-3', full_name: 'Piet App', email: 'app1@houtrotherstel.nl', role: 'app_gebruiker' as const },
  { ...mockProfile, id: 'mock-4', full_name: 'Lisa App', email: 'app2@houtrotherstel.nl', role: 'app_gebruiker' as const },
]
...
export default function GebruikersPage() {
  return (
    <div className="space-y-6 pb-20 lg:pb-0">
      <PageHeader
        title="Gebruikers"
        description={`${mockGebruikers.length} gebruikers`}
        actions={
          <Link href="/gebruikers/nieuw"

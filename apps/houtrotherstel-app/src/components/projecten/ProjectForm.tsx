...
export default function ProjectForm({ project, userId, onSuccess }: ProjectFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      {/* Sectie: Locatie */}
      <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
        <h2 className="font-semibold text-slate-800">Locatie</h2>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-4">
        <h2 className="font-semibold text-slate-800">Contactpersoon</h2>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <h2 className="font-semibold text-slate-800 mb-4">Notities</h2>
      ...
      <div className="flex gap-3 justify-end">
        <button
          ...
          className="px-4 py-2.5 text-sm font-medium text-slate-700 bg-white border border-slate-300
            hover:border-slate-400 rounded-lg transition-colors"
        >
          Annuleren
        </button>
        <button
        ...
        >
          ...
          {isLoading ? 'Opslaan...' : isEdit ? 'Wijzigingen opslaan' : 'Project aanmaken'}
        </button>
      </div>
    </form>
  )

...
import type { Project, Projectdeel, Locatie, Registratie, RegistratieStatus } from '@/lib/types'
      ...
      <div className="space-y-3">
        ...
        {registraties.length === 0 && !showAddForm && (
          <div className="text-center py-12 text-slate-400 bg-white rounded-xl border border-dashed border-slate-300">
            ...
            <p className="text-sm mt-1">Maak een registratie aan voor een werkbezoek of inspectie</p>
          </div>
        )}
      </div>
    </div>

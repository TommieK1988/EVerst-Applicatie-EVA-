 ...
 * vast (aanraakscherm + user-agent, zie `lib/mobiel-apparaat.ts`) en legt het
 * hier vast, zodat de middleware er bij elk volgend verzoek al vóór het renderen
 * op kan beslissen — en de gebruiker dus niet meer heen en weer springt tussen
 * de mobiele en de platformweergave.
 *
